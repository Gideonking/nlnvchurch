...
-- Dumping database structure for nlnvchurch
CREATE DATABASE IF NOT EXISTS `nlnvchurch` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `nlnvchurch`;

-- Dumping structure for table nlnvchurch.albums
...
-- Dumping data for table nlnvchurch.albums: ~6 rows (approximately)
DELETE FROM `albums`;
...
-- Dumping structure for table nlnvchurch.bulletins
...
-- Dumping data for table nlnvchurch.bulletins: ~2 rows (approximately)
...
-- Dumping structure for table nlnvchurch.news
...
-- Dumping data for table nlnvchurch.news: ~4 rows (approximately)
DELETE FROM `news`;
...
-- Dumping structure for table nlnvchurch.photos
...
-- Dumping data for table nlnvchurch.photos: ~88 rows (approximately)
DELETE FROM `photos`;
...
-- Dumping structure for table nlnvchurch.series
...
-- Dumping data for table nlnvchurch.series: ~11 rows (approximately)
DELETE FROM `series`;
...
-- Dumping structure for table nlnvchurch.videos
...
-- Dumping data for table nlnvchurch.videos: ~179 rows (approximately)
DELETE FROM `videos`;
