...
@section('content')
  ...
  <div class="about__tab-section">
  	...
  	<ul class="about__tab-contents">
  		<li class="about__tab-content active">
  		...
  		<li class="about__tab-content">
  			<div class="about__tab-content-wrapper kor-main">
          <p>New Life New Vision 교회를 방문해 주시는 여러분 모두를 환영합니다. 우리 뉴라이프 뉴비전 교회는 미국 최대의 복음주의 교단인 남침례교단 (Southern Baptist Convention)에 속해 있습니다. 우리 교회는 "다음 세대를 위해 교회를 개척하는 교회" 라는 사명을 갖고 지속적인 교회 개척을 목표로 사역하는 교회입니다.저는 우리 교회가 따뜻함이 넘치는 교회, 하나님이 기뻐하시는 열매를 풍성히 맺는 교회, 선한 영향력을 주는 교회, 삶 가운데 지친 영혼들이 힘을 공급받는 교회, 기도와 기적이 넘치는 교회가 되길 소망합니다. 믿음 안에서 계속적인 만남이 있길 바라며...</p>
          <p>In Him,</p>
          <p>Peter 최 목사</p>
          <p>*약력</p>
          <p>UCLA B.A.</p>
  		...
  		<li class="about__tab-content">
  			<div class="about__tab-content-wrapper">
          <h1>Content 3</h1>
        </div>
  		</li>
  	</ul>
