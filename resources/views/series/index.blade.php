...
@section('content')
  ...
  <div class="home__container home__container--sm home__message home__container--dark clearfix">
    <div class="col-md-6 margin-top-md margin-bottom-md">
      <div class="col-md-12">
        <iframe class="home__message-iframe" width="100%" height="500" src="https://www.youtube.com/embed/{{ $first_message->video_id }}?rel=0" frameborder="0" allowfullscreen></iframe>
      </div>
    </div>
    <div class="col-md-6 margin-top-md margin-bottom-md">
      <div class="col-md-12">
          ...
          <div class="col-sm-6 col-md-4 messages__card">
            <a class="js-lazy messages__card-inner" data-src="https://i.ytimg.com/vi/{{ $single_series->videos->first()->video_id }}/maxresdefault.jpg" href="/series/{{ $single_series->id }}">
              <div class="messages__card-content">
                <p class="messages__card-desc kor-main text-center">{{ $single_series->title }}</p>
                <p class="messages__card-desc kor-main text-center">시리즈</p>
              </div>
            </a>
          </div>
      @endforeach
